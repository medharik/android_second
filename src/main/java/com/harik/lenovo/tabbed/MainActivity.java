...
public class MainActivity extends AppCompatActivity {
    ...
    public static class Fragment2 extends Fragment{
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
           ...
           // TextView textView = (TextView) rootView.findViewById(R.id.section_label);
            //textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER2)));
            return rootView;
        }
    }
    ...
    public static class Fragment3 extends Fragment {
         ...
         * fragment.
         */
        private static final String ARG_SECTION_NUMBER3= "section_number 3";
        ...
        public static Fragment3 newInstance(int sectionNumber) {
            ...
            Bundle args = new Bundle();
            args.putInt(ARG_SECTION_NUMBER3, sectionNumber);
            fragment.setArguments(args);
            return fragment;
        }
...
WebView web=(WebView)rootView.findViewById(R.id.webviewfragment);
